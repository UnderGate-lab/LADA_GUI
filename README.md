...
[Release](https://github.com/UnderGate-lab/LADA_GUI/releases](https://github.com/UnderGate-lab/LADA_GUI/releases/tag/V1.1)の`lada_gui.exe`をLADAインストールフォルダ（lada-cli.exeがあるフォルダ）にコピーします。
